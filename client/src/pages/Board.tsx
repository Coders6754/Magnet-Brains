    ...
    return (
        <>
            <DragDropContext onDragEnd={onDragEnd}>
                <div className="min-h-[100vh] bg-gray-800 p-5 flex flex-col gap-5 md:flex-row">
                    <div className="bg-black text-[#b6c2cf] px-5 py-3 rounded-lg flex flex-col md:w-[25%] h-max">
                        <h1 className="text-base font-bold p-1">To do</h1>
                        {
                            loading ?
                ...
                <Box sx={style}>
                    ...
                    <div className="md:flex md:gap-10">
                        <div className="md:w-[70%]">
                            ...
                            <ReactQuill
                                className="my-4 dark:border-secondary-40 border-black-1000 rounded-md text-white dark:text-white"
                            ...
                            {isChecklistOpen && (
                                <div>
                                    ...
                                    <button onClick={addChecklistItem} className="mb-3 bg-yellow-100 rounded text-black font-semibold px-2.5 py-1">Add Checklist Item</button>
                                </div>
                            )}
                        </div>
                        <div>
                    ...
                    <div className="flex gap-2">
                        <button
                            className="bg-green-300 rounded text-black font-semibold px-2.5 py-1 mt-3"
                            onClick={handleSubmit}
                        >
                            Save
                        </button>
                        <button
                            className="bg-red-300 rounded text-black font-semibold px-2.5 py-1 mt-3"
                ...
                <Box sx={style}>
                    <div className="md:flex md:gap-10">
                        <div className="md:w-[70%]">
                            ...
                            <ReactQuill
                                className="my-4 dark:border-secondary-40 border-gray-400 rounded-md text-white dark:text-white"
                                placeholder="Write something here..."
                                modules={modules}
                                formats={formats}
                                value={formData.description}
