    ...
    return (
        <>
            <div className="h-[10vh] bg-[#1c2025] px-5 flex items-center justify-between md:px-14">
                <h1 onClick={() => nav('/')} className="flex font-extrabold text-2xl text-red-200 md:text-3xl cursor-pointer">Task<p className="text-red-500">Management</p></h1>
                {state.isAuthenticated ?
                    ...
                    <div className="hidden md:flex">
                        <button className="text-red-500 px-6 py-1.5 font-bold" onClick={() => {
                            handleOpenLogin()
                            setFormData({
                                name: "", email: "", password: "",
                            })
                        }}>Log In</button>
                        <button className="bg-red-500 px-5 py-1.5 rounded font-bold" onClick={() => {
                            handleOpenSignup()
                            setFormData({
                                name: "", email: "", password: "",
                            })
            ...
            >
                <Box sx={style}>
                    <h1 className="text-red-500 text-center text-3xl font-extrabold mb-3">Log In Form</h1>
                    <form action="" className="flex flex-col gap-4" onSubmit={handleLogin}>
                        ...
                        <button className="bg-red-500 px-5 py-1.5 rounded font-bold flex justify-center transform transition-transform duration-1000 ease-in-out hover:rotate-360" type="submit">
                            {
            ...
            >
                <Box sx={style}>
                    <h1 className="text-red-500 text-center text-3xl font-extrabold mb-3">Sign up Form</h1>
